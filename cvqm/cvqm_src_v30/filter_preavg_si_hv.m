function [si, hv, hvb] = filter_preavg_si_hv(y, varargin)
% FILTER_PREAVG_SI_HV
%
%  Filters Y with the 13x13 gradient (c=2) filters described in SPIE 1999 paper
%  However, average images in time before starting calculation. 
%
% SYNTAX
%
%  [SI] = filter_preavg_si_hv(Y)
%  [SI] = filter_preavg_si_hv(Y, rmin, theta)
%  [SI, HV, HVB] = filter_preavg_si_hv(...)
%
% DESCRIPTION
%
